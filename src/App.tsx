    ...
    <div className="flex justify-between items-center">
      <div className="flex items-center gap-3">
        <div className="w-12 h-12 rounded-full border-2 border-burgundy p-0.5">
          <img 
            src={getImagePath("/WhatsApp Image 2024-02-02 at 00.27.25_2a93954d.jpg")} 
            alt="LinkedIn" 
            className="w-full h-full rounded-full object-cover"
            referrerPolicy="no-referrer"
          />
          ...
          <div className="md:col-span-8 relative rounded-[3rem] overflow-hidden group h-[500px] shadow-2xl">
            ...
            >
              <div className="w-10 h-10 rounded-full overflow-hidden border border-cream/20">
                <img src={getImagePath("/WhatsApp Image 2025-08-27 at 19.26.07_8b094d64.jpg")} alt="Profile" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
              </div>
              <div>
          ...
          <div className="card-beige p-12 relative overflow-hidden">
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-12">
              <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-burgundy shadow-2xl flex-shrink-0">
                <img src={getImagePath("/WhatsApp Image 2025-08-27 at 19.26.07_8b094d64.jpg")} alt="Visual Diary" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
              </div>
              <div>
